      ...
      <div className="flex h-full">
        ...
        <div className="w-1/2 flex items-center justify-center p-16">
          <div className="rounded-full shadow-2xl bg-gray-800 p-4" style={{width: '576px', height: '576px'}}>
            <div className="w-full h-full rounded-full overflow-hidden" style={{backgroundImage: "url('https://cdn.shopify.com/s/files/1/0691/8347/1670/files/Me2.jpg?v=1758000150')", backgroundSize: 'cover', backgroundPosition: 'center'}}>
            </div>
          </div>
        </div>
      </div>
